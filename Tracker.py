...
class Tracker:
    def __init__(self, device="cuda") -> None:
        ...
        self.deepsort = DeepSort(self.deepsort_ckpt_path, use_cuda=self.device)

        self._COLORS_10 =[(144,238,144),(178, 34, 34),(221,160,221),(  0,255,  0),(  0,128,  0),(210,105, 30),(220, 20, 60),
    ...
    def _detect_objects(self, image):
        predictions = self._yolonas.predict(image)
    ...
    def _draw_boxes(self, img, index, bbox, identities=None, offset=(0,0)):
        ...
        for i,box in enumerate(bbox):
            ...
            color = self._COLORS_10[id%len(self._COLORS_10)]
            label = '{}{:d}'.format("", id)
